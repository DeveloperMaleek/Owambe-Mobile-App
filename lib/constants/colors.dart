...
class AppColor {
  static Color primaryColor = const Color(0xFF0FB7FF);
  static Color lightBackgroundColor = const Color(0xFFF7F7F7);
  static Color subtitleTextColor = const Color(0xFF8C8CA1);
  static Color primaryTextColor = const Color(0xFF4A4A68);
